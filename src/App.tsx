  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'dark bg-[#1C1C1C]' : 'bg-gray-100'}`}>
      <button
        ...
        className="fixed top-4 right-4 z-50 p-2 rounded-full bg-gray-200 dark:bg-[#232323] hover:bg-gray-300 dark:hover:bg-[#333333]"
      >
      ...
      <header className="relative h-screen flex items-center justify-center bg-gradient-to-br from-[#1C1C1C] to-purple-900 text-white">
        <div className="absolute inset-0 w-full h-full pointer-events-none">
          <video
            ...
            className="w-full h-full object-cover custom-video-style"
            preload="auto"
